...
<html>
<head>
<title>Edit <fmt:message key="guest.title"/> <fmt:message key="reservation.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveGuestReservations" method="POST" modelAttribute="reservation">
