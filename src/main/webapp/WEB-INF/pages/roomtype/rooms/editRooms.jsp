...
<html>
<head>
<title>Edit <fmt:message key="roomtype.title"/> <fmt:message key="room.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveRoomtypeRooms" method="POST" modelAttribute="room">
