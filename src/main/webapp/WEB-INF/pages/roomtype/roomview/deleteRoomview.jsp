...
<html>
<head>
<title>View <fmt:message key="roomtype.title"/> <fmt:message key="roomview.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			<h1><fmt:message key="navigation.view"/> <fmt:message key="roomview.title"/></h1>
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deleteRoomtypeRoomview?roomtype_roomTypeId=${roomtype_roomTypeId}&related_roomview_roomViewId=${roomview.roomViewId}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
