...
<html>
<head>
<title>Edit <fmt:message key="roomtype.title"/> <fmt:message key="bed.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveRoomtypeBed" method="POST" modelAttribute="bed">
