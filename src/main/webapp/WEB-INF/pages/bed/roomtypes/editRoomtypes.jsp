...
<html>
<head>
<title>Edit <fmt:message key="bed.title"/> <fmt:message key="roomtype.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveBedRoomtypes" method="POST" modelAttribute="roomtype">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="bed_bedId" value="${bed_bedId}" >
