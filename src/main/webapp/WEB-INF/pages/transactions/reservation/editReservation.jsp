...
<html>
<head>
<title>Edit <fmt:message key="transactions.title"/> <fmt:message key="reservation.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveTransactionsReservation" method="POST" modelAttribute="reservation">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="transactions_transactionId" value="${transactions_transactionId}" >
