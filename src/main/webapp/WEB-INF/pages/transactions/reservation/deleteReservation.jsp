...
<html>
<head>
<title>View <fmt:message key="transactions.title"/> <fmt:message key="reservation.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/selectTransactions?transactionIdKey=${transactions_transactionId}&"><span><img src="images/icons/back.gif" /><fmt:message key="navigation.back"/></span></a></div>
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deleteTransactionsReservation?transactions_transactionId=${transactions_transactionId}&related_reservation_reservationId=${reservation.reservationId}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
