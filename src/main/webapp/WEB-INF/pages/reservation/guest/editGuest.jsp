...
<html>
<head>
<title>Edit <fmt:message key="reservation.title"/> <fmt:message key="guest.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveReservationGuest" method="POST" modelAttribute="guest">
