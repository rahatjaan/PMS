...
<html>
<head>
<title>Edit <fmt:message key="reservation.title"/> <fmt:message key="transactions.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveReservationTransactionses" method="POST" modelAttribute="transactions">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="reservation_reservationId" value="${reservation_reservationId}" >
