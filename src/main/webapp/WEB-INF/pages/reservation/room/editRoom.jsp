...
<html>
<head>
<title>Edit <fmt:message key="reservation.title"/> <fmt:message key="room.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveReservationRoom" method="POST" modelAttribute="room">
