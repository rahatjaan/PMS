...
<html>
<head>
<title>Edit <fmt:message key="room.title"/> <fmt:message key="roomtype.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveRoomRoomtype" method="POST" modelAttribute="roomtype">
