...
<html>
<head>
<title>View <fmt:message key="room.title"/> <fmt:message key="roomtype.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deleteRoomRoomtype?room_roomId=${room_roomId}&related_roomtype_roomTypeId=${roomtype.roomTypeId}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
