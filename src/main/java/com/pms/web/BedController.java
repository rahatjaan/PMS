...
public class BedController {
	...
	public ModelAndView confirmDeleteBed(@RequestParam String bedIdKey) {
		ModelAndView mav = new ModelAndView();
	...
	public ModelAndView selectBedRoomtypes(@RequestParam String bed_bedId, @RequestParam String roomtypes_roomTypeId) {
	...
	public ModelAndView selectBed(@RequestParam String bedIdKey) {
		ModelAndView mav = new ModelAndView();
	...
	public String deleteBed(@RequestParam String bedIdKey) {
	...
	public ModelAndView listBedRoomtypes(@RequestParam String bedIdKey) {
		ModelAndView mav = new ModelAndView();
	...
	public ModelAndView saveBedRoomtypes(@RequestParam String bed_bedId, @ModelAttribute Roomtype roomtypes) {
	...
	public ModelAndView newBedRoomtypes(@RequestParam String bed_bedId) {
		ModelAndView mav = new ModelAndView();
		mav.addObject("bed_bedId", bed_bedId);
	...
	public ModelAndView editBedRoomtypes(@RequestParam String bed_bedId, @RequestParam String roomtypes_roomTypeId) {
		Roomtype roomtype = roomtypeDAO.findRoomtypeByPrimaryKey(roomtypes_roomTypeId, -1, -1);
	...
	public ModelAndView editBed(@RequestParam String bedIdKey) {
		ModelAndView mav = new ModelAndView();
	...
	public ModelAndView confirmDeleteBedRoomtypes(@RequestParam String bed_bedId, @RequestParam String related_roomtypes_roomTypeId) {
		ModelAndView mav = new ModelAndView();
	...
	public ModelAndView deleteBedRoomtypes(@RequestParam String bed_bedId, @RequestParam String related_roomtypes_roomTypeId) {
		ModelAndView mav = new ModelAndView();
