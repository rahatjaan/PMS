...
public class RoomRestController {
	...
	@ResponseBody
	public Roomtype newRoomRoomtype(@PathVariable Integer room_roomId, @RequestBody Roomtype roomtype) {
	...
	@ResponseBody
	public void deleteRoom(@PathVariable Integer room_roomId) {
	...
	@ResponseBody
	public Room loadRoom(@PathVariable Integer room_roomId) {
	...
	@ResponseBody
	public Reservation loadRoomReservations(@PathVariable Integer room_roomId, @PathVariable Integer related_reservations_reservationId) {
	...
	@ResponseBody
	public void deleteRoomRoomtype(@PathVariable Integer room_roomId, @PathVariable Integer related_roomtype_roomTypeId) {
	...
	@ResponseBody
	public Roomtype loadRoomRoomtype(@PathVariable Integer room_roomId, @PathVariable Integer related_roomtype_roomTypeId) {
	...
	@ResponseBody
	public Roomtype saveRoomRoomtype(@PathVariable Integer room_roomId, @RequestBody Roomtype roomtype) {
		roomService.saveRoomRoomtype(room_roomId, roomtype);
		return roomtypeDAO.findRoomtypeByPrimaryKey(roomtype.getRoomTypeId());
	}
	...
	@ResponseBody
	public void deleteRoomReservations(@PathVariable Integer room_roomId, @PathVariable Integer related_reservations_reservationId) {
	...
	@ResponseBody
	public Reservation newRoomReservations(@PathVariable Integer room_roomId, @RequestBody Reservation reservation) {
	...
	@ResponseBody
	public Roomtype getRoomRoomtype(@PathVariable Integer room_roomId) {
	...
	@ResponseBody
	public Reservation saveRoomReservations(@PathVariable Integer room_roomId, @RequestBody Reservation reservations) {
	...
	@ResponseBody
	public List<Reservation> getRoomReservations(@PathVariable Integer room_roomId) {
