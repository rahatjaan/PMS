...
public interface GuestDAO extends JpaDao<Guest> {
	 ...
	 *
	 */
	public Guest findGuestByGuestId(Integer guestId_1) throws DataAccessException;

	/**
	 * JPQL Query - findGuestByGuestId
	 *
	 */
	public Guest findGuestByGuestId(Integer guestId_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<Guest> findGuestByLastNameContaining(String lastName_1) throws DataAccessException;

	/**
	 * JPQL Query - findGuestByLastNameContaining
	 *
	 */
	public Set<Guest> findGuestByLastNameContaining(String lastName_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<Guest> findGuestByCountry(String country_1) throws DataAccessException;

	/**
	 * JPQL Query - findGuestByCountry
	 *
	 */
	public Set<Guest> findGuestByCountry(String country_1, int startResult, int maxRows) throws DataAccessException;

	/**
	 * JPQL Query - findGuestByMobileNumber
	 *
	 */
	public Set<Guest> findGuestByMobileNumber(String mobileNumber_1) throws DataAccessException;

	/**
	 * JPQL Query - findGuestByMobileNumber
	 *
	 */
	public Set<Guest> findGuestByMobileNumber(String mobileNumber_1, int startResult, int maxRows) throws DataAccessException;

	/**
	 * JPQL Query - findGuestByFirstNameContaining
	 *
	 */
	public Set<Guest> findGuestByFirstNameContaining(String firstName_1) throws DataAccessException;

	/**
	 * JPQL Query - findGuestByFirstNameContaining
	 *
	 */
	public Set<Guest> findGuestByFirstNameContaining(String firstName_1, int startResult, int maxRows) throws DataAccessException;
