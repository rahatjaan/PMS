...
public class RoomtypeDAOTest {
	 ...
	 *
	 */
	private RoomtypeDAO dataStore;

	/**
	 * Instantiates a new RoomtypeDAOTest.
	 *
	 */
	public RoomtypeDAOTest() {
	}

	/**
	 * Method to test Roomtype domain object.
	 *
	 */
	@Rollback(false)
	@Test
	 ...
	 */
	@Autowired
	public void setDataStore(RoomtypeDAO dataStore) {
