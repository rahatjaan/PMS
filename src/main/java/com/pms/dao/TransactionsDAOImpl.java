...
public class TransactionsDAOImpl extends AbstractJpaDao<Transactions> implements
	 ...
	 */
	@Transactional
	public Set<Transactions> findTransactionsByTransactionIdContaining(String transactionId) throws DataAccessException {

		return findTransactionsByTransactionIdContaining(transactionId, -1, -1);
	}
	...
	@SuppressWarnings("unchecked")
	@Transactional
	public Set<Transactions> findTransactionsByTransactionIdContaining(String transactionId, int startResult, int maxRows) throws DataAccessException {
		Query query = createNamedQuery("findTransactionsByTransactionIdContaining", startResult, maxRows, transactionId);
		return new LinkedHashSet<Transactions>(query.getResultList());
	}
	 ...
	 */
	@Transactional
	public Transactions findTransactionsByTransactionId(String transactionId) throws DataAccessException {
	...
	@Transactional
	public Transactions findTransactionsByTransactionId(String transactionId, int startResult, int maxRows) throws DataAccessException {
		try {
