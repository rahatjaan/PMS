...
public class TransactionsDAOTest {
	 ...
	 *
	 */
	private TransactionsDAO dataStore;

	/**
	 * Instantiates a new TransactionsDAOTest.
	 *
	 */
	...
	/**
	 * Method to test Transactions domain object.
	 *
	 */
	@Rollback(false)
	@Test
	 ...
	 */
	@Autowired
	public void setDataStore(TransactionsDAO dataStore) {
