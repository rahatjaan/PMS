...
public class ReservationServiceImpl implements ReservationService {
	 ...
	 */
	@Transactional
	public Reservation deleteReservationRoom(String reservation_reservationId, String related_room_roomId) {
		Reservation reservation = reservationDAO.findReservationByPrimaryKey(reservation_reservationId, -1, -1);
	 ...
	 */
	@Transactional
	public Reservation deleteReservationGuest(String reservation_reservationId, String related_guest_guestId) {
		Reservation reservation = reservationDAO.findReservationByPrimaryKey(reservation_reservationId, -1, -1);
	 ...
	 */
	@Transactional
	public Reservation findReservationByPrimaryKey(String reservationId) {
	 ...
	 */
	@Transactional
	public Reservation saveReservationRoom(String reservationId, Room related_room) {
		Reservation reservation = reservationDAO.findReservationByPrimaryKey(reservationId, -1, -1);
	 ...
	 */
	@Transactional
	public Reservation saveReservationGuest(String reservationId, Guest related_guest) {
		Reservation reservation = reservationDAO.findReservationByPrimaryKey(reservationId, -1, -1);
